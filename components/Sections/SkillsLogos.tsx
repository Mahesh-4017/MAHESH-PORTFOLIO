...
const ROW1: LogoItem[] = [
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" className="h-6 w-6 transition-colors duration-300" fill="currentColor">
        <path d="M1.5 0h21l-1.91 21.563L12 24l-8.59-2.437L1.5 0zm17.3 6.18H6.74l.32 3.58h10.88l-.32 3.58H12v2.04l3.52-.98.24-2.72H9.06l-.16-1.88h7.94l.44-5.02z" />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" className="h-6 w-6 transition-colors duration-300" fill="currentColor">
        <path d="M1.5 0h21l-1.91 21.563L12 24l-8.59-2.437L1.5 0zm17.3 6.18H12v3.58h4.54l-.44 5.02L12 15.76l-4.1-1.16-.26-3.02h2.24l.14 1.58L12 13.82l2.02-.56.24-2.58H6.9l-.44-5.02H18.8z" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" className="h-6 w-6 transition-colors duration-300" fill="currentColor">
        <path d="M0 0h24v24H0zm10.74 13.91H7.8v5.39h-2v-5.39H2.9v-1.72h7.84v1.72zm9.1 2.22c0 1-.58 1.61-1.64 1.61-1 0-1.53-.47-1.73-1.23l-1.68.74c.48 1.34 1.57 2.25 3.46 2.25 2.19 0 3.6-1.21 3.6-3.23 0-4-5.11-3.26-5.11-4.74 0-.6.54-.95 1.27-.95.84 0 1.38.39 1.59.98l1.65-.8c-.53-1.23-1.76-1.98-3.24-1.98-2.02 0-3.32 1.12-3.32 3.01 0 3.73 5.02 3.02 5.02 4.37z" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" className="h-6 w-6 transition-colors duration-300" fill="currentColor">
        <path d="M12 1.344a1.8 1.8 0 0 0-.9.23L4.1 5.564a1.8 1.8 0 0 0-.9 1.56v7.76a1.8 1.8 0 0 0 .9 1.56l7 3.99a1.8 1.8 0 0 0 1.8 0l7-3.99a1.8 1.8 0 0 0 .9-1.56V7.124a1.8 1.8 0 0 0-.9-1.56l-7-3.99a1.8 1.8 0 0 0-.9-.23zm.1 2.378l6 3.42V14.1l-6 3.42-6-3.42V7.142l6-3.42z" />
      </svg>
    ),
  },
  {
...
const ROW2: LogoItem[] = [
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" className="h-6 w-6 transition-colors duration-300" fill="currentColor">
        <path d="M12 .002a28.09 28.09 0 0 0-4.444 7.62C6.611 10.153 6 12.637 6 15c0 3.314 2.686 6 6 6s6-2.686 6-6c0-2.363-.611-4.847-1.556-7.378A28.09 28.09 0 0 0 12 .002zm0 3.033c.895 2.146 1.79 4.39 2.502 6.7C15.114 11.758 15.5 13.414 15.5 15c0 1.933-1.567 3.5-3.5 3.5S8.5 16.933 8.5 15c0-1.586.386-3.242.998-5.267C10.21 7.425 11.105 5.18 12 3.035z" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" className="h-6 w-6 transition-colors duration-300" fill="currentColor">
        <path d="M23.3 10.9L13.1.7c-.9-.9-2.4-.9-3.3 0L7.4 3.1l3.3 3.3c.7-.2 1.5-.1 2.1.5.6.6.7 1.4.5 2.1l3.3 3.3c.7-.2 1.5-.1 2.1.5.8.8.8 2.1 0 2.9-.8.8-2.1.8-2.9 0-.6-.6-.7-1.4-.5-2.1L12 9.8c-.2.2-.4.3-.7.3s-.5-.1-.7-.3c-.6-.6-.7-1.4-.5-2.1L6.8 4.4 1 10.2c-.9.9-.9 2.4 0 3.3l10.2 10.2c.9.9 2.4.9 3.3 0l8.8-8.8c1-.9 1-2.4 0-3.3z" />
      </svg>
    ),
  },
  {
